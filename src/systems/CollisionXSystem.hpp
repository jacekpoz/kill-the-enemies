...
class CollisionXSystem : public System {

public:
	CollisionXSystem(entt::registry &r, Config &c);

	void update(const float deltaTime) override;
private:
	void resolveCollisionX(const entt::entity e1, const entt::entity e2, const float deltaTime);

	void movableImmovableX(const entt::entity m, const entt::entity i, const float deltaTime);
